...
<body class="site">
<div class="ui grid ">
<div class="ui equal width grid container segment">
 
          
		<div class="column center aligned"><h1 class="ui  header">Donsai kita</h1>
...
<div class="ui stackable menu">
  ...
  <div class="ui stackable grid full">
    <div class="ui grid container segment">
      <div class="ui twelve wide column grid">
        <div class="ui red row segment">
          <h4 class="ui header">Berita kini</h4>
        </div>
      </div>

      <div class="ui four wide column">
        <div class="ui inverted blue row segment">
          <h4 class="ui header">temukan kami</h4>
    ...
    <?php 
	include_once"tampil/footer.php";
    ?>