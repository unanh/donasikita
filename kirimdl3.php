				...
				<div class="ten right aligned column">
					<div class="ui icon input">
						...
						<div class="ui placeholder segment">
							<div class="content">
								<h4 class="ui center aligned column teal header" >Selesai</h4>
							</div>
							<center>
...
Terimakasih data anda sudah masuk daftar donatur semoga kebaikan anda di balas berlipat ganda oleh Tuhan amin
											</tr>
											<tr>
												<td> </td><td></td><td><a href="index.html" >Terimakasih</a></td>
											</tr>
										</div>
									</table>
